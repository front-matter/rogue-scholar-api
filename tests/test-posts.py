...
""",
        ...
        "doi": "https://doi.org/10.59350/evaf9-2qf48",
        "language": "en",
        "reference": [],
        "relationships": [],
        "tags": ["Tech Notes", "Multilingual"],
    ...
    result = upsert_single_record(post)
    assert result.id == "https://doi.org/10.59350/evaf9-2qf48"
...
def test_get_relationships_preprint():
    ...
    assert result[0] == {
        "type": "IsPreprintOf",
        "urls": ["https://doi.org/10.18357/kula.291"],
    }
