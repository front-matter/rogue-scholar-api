...
postsSelect = "guid, doi, url, title, summary, abstract, published_at, updated_at, registered_at, authors, image, tags, language, reference, relationships, citations, blog_name, content_text, rid"
postsWithConfigSelect = "id, guid, doi, url, archive_url, title, summary, abstract, published_at, updated_at, registered_at, indexed_at, indexed, authors, image, tags, language, reference, relationships, citations, blog_name, blog_slug, rid, blog: blogs!inner(slug, title, description, feed_url, home_page_url, language, category, status, generator, license, updated_at)"
