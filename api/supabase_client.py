...
postsSelect = "guid, doi, parent_doi, url, title, summary, abstract, published_at, updated_at, registered_at, authors, image, tags, language, reference, relationships, funding_references, blog_name, content_text, rid, version"
...
postsWithContentSelect = "id, guid, doi, parent_doi, url, archive_url, title, summary, abstract, content_text, published_at, updated_at, registered_at, indexed_at, authors, image, tags, language, reference, relationships, funding_references, blog_name, blog_slug, rid, version, blog: blogs!inner(*)"
