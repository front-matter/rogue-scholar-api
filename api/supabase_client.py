...
postsSelect = "guid, doi, url, title, summary, abstract, published_at, updated_at, authors, image, tags, language, reference, relationships, blog_name, content_text, invenio_id"
...
postsWithBlogSelect = "id, guid, doi, url, archive_url, title, summary, abstract, published_at, updated_at, indexed_at, indexed, authors, image, tags, language, reference, relationships, blog_name, blog_slug,invenio_id,  blog: blogs!inner(*)"
postsWithContentSelect = "id, guid, doi, url, archive_url, title, summary, abstract, content_text, published_at, updated_at, indexed_at, authors, image, tags, language, reference, relationships, blog_name, blog_slug, invenio_id, blog: blogs!inner(*)"
postsForUpsertSelect = "id, guid, doi, url, archive_url, title, summary, abstract, published_at, updated_at, indexed_at, authors, image, tags, language, reference, relationships, blog_name, blog_slug, invenio_id, blog: blogs!inner(*)"
worksSelect = "*"
