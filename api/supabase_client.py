...
postsWithContentSelect = "id, guid, doi, parent_doi, url, archive_url, title, summary, abstract, content_html, subfield, topic, topic_score, published_at, updated_at, registered_at, indexed_at, authors, image, tags, language, reference, relationships, funding_references, blog_name, blog_slug, rid, version, blog: blogs!inner(*)"
...
postsWithCitationsSelect = "id, guid, doi, parent_doi, url, archive_url, title, summary, abstract, content_html, subfield, topic, topic_score, published_at, updated_at, registered_at, indexed_at, authors, image, tags, language, reference, relationships, funding_references, blog_name, blog_slug, rid, version, blog: blogs!inner(*), citations: citations!inner(citation, unstructured, validated, updated_at, published_at)"
citationsSelect = "citation, unstructured, validated, updated_at, published_at"
citationsWithDoiSelect = (
    "doi, citation, unstructured, validated, updated_at, published_at, type"
)
citationsWithCidSelect = (
    "cid, doi, citation, unstructured, validated, updated_at, published_at, type"
)
